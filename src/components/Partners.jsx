    ...
    <section className="text-center py-10 px-5">
      ...
      <div className="flex justify-center items-center mt-6">
        <Image
          ...
          className="w-[100%] md:w-[90%] lg:w-[100%] max-w-full h-auto py-4"
          priority
        />
      </div>
      <div>
        <button className="  py-3.5 px-10 text-white text-[10px] rounded-md bg-[#2a80b4] hover:bg-[#9ecb75] md:text-2xl font-extrabold hover:text-black  transition duration-300">
