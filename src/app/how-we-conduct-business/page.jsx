...
const Conduct = () => {
  return (
    <div className="max-w-6xl mx-auto pt-40 pb-10 px-2 md:px-0">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="border-2 border-gray-950 max-w-[300px] flex flex-col gap-4 items-center py-4 mx-auto">
          ...
          <Link
            ...
            passHref
          >
            <button className="p-2.5 md:p-3.5 uppercase rounded bg-[#9ecb75] hover:bg-[#2a80b4] hover:text-white transition duration-300">
                Download Now
            </button>
          </Link>
        </div>
