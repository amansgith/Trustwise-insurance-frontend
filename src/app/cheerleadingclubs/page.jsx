      ...
      <Associations
        ...
        description={
          <>
            ...
            <br />
            <p>
              The program is available to all the employees of Cheerleading Clubs member
              companies, their spouses, and dependent children residing at home
              or away from school.
            </p>
            <br />
            <p>
              Be sure to mention when you call that you are a member of the Cheerleading Clubs.
            </p>
          </>
        }
        imageSrc="https://www.aaxel.ca/wp-content/uploads/2023/07/Cheerleading-Clubs.webp"
...
export default CheerleadingClubs;
