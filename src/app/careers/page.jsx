  ...
  return (
    <div className="flex flex-col min-h-screen">
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="bg-[url('https://highrise.mikado-themes.com/wp-content/uploads/2016/10/Team-Title-1-1.jpg')] bg-cover bg-opacity-10 text-primary-foreground py-20 text-center">
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl text-[#2a80b4] font-bold text-center mb-12">
              Why Work With Us?
            </h2>
              ...
              {[
                {
                  ...
                  description:
                    "Work with a diverse team of passionate individuals",
                },
                {
                  icon: Briefcase,
                  title: "Career Growth",
                ...
                <Card key={index}>
                  <CardHeader>
                    ...
                    <CardTitle className="text-[#9ecb75]">
                      {item.title}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
