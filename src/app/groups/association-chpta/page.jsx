...
const AssociationCHPTA = () => {
  return (
    <>
      <Associations
        title="Canadian Home Products Trade Association - CHPTA"
        description={
          <>
            <b>Your coverage, your way...</b>
            <p><br />
              Aaxel Insurance Brokers Ltd. and CHPTA are pleased to offer the
              following insurance programs for its members and their employees:
            </p>
            <ol className="list-decimal list-inside">
              <li>Group home & auto insurance</li>
            ...
            <p><br />
              The program is available to all the employees of CHPTA member
