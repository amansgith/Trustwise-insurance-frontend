      ...
      <div className="min-h-screen bg-gray-100 mt-24 md:mt-6 md:pt-0">
        <InsuranceIntro
          ...
          description={
            ...
            <br />
              <h2><b>Key Features of TFSA:</b></h2>
              <ul>
                <li>
                  <strong>Tax-Free Growth:</strong> All earnings within a TFSA
                  are exempt from taxes, allowing your investments to compound
                  more effectively.
                </li>
                <li>
                  <strong>Flexible Contributions:</strong> While there are
                  annual contribution limits, any unused room can be carried
            ...
            <br />
              <ul>
                ...
                <li>
                  <strong>Expert Guidance:</strong> Our team of financial
                  advisors helps you navigate the intricacies of TFSAs, ensuring
