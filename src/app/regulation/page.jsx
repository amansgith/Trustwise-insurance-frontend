    ...
    <div className="bg-gray-50 min-h-screen py-16 px-4 sm:px-8">
      ...
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-4xl font-bold text-gray-900 flex items-center gap-2 justify-center">
          <span className="border-l-4 border-green-500 pl-2">Regulation</span>
        </h2>
      ...
      <div className="max-w-6xl mx-auto mt-12">
        <h3 className="text-2xl font-bold text-blue-700 text-center relative pb-3">
          Documents
          <div className="absolute left-1/2 transform -translate-x-1/2 w-24 h-1 bg-green-500 mt-2"></div>
        </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-8">
          {documents.map((doc, index) => (
            ...
            >
              <MdOutlineDescription className="text-blue-600 text-5xl" />
              <h4 className="text-lg font-semibold text-gray-900 mt-4">
                {doc.title}
              </h4>
              <a
                href={doc.href}
                className="mt-4 inline-flex items-center bg-blue-600 text-white font-semibold px-5 py-2 rounded-lg shadow-md hover:bg-blue-700 transition"
              >
